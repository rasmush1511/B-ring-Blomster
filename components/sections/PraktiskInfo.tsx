...
export default function PraktiskInfo() {
  return (
    ...
    >
      <BotanicalDecor variant="leaves-left" className="left-0 bottom-0 w-56 h-full" opacity={0.1} />
      <BotanicalDecor variant="stem-right" className="right-8 top-0 w-20 h-full" opacity={0.08} />
          ...
          <FadeIn delay={0.1}>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-white/50">Adresse</span>
              </div>
          ...
          <FadeIn delay={0.15}>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-white/50">Åbningstider</span>
              </div>
              ...
              <p className="text-xs text-white/40">Sæson: {virksomhed.sæson}</p>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-white/50">Telefon</span>
              </div>
              <a href={`tel:${virksomhed.telefon}`} className="text-white hover:text-[var(--color-accent)] transition-colors self-start link-underline">
          ...
          <FadeIn delay={0.25}>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium uppercase tracking-widest text-white/50">Betaling</span>
              </div>
              <p className="text-white">MobilePay</p>
              <p className="text-sm text-white/55">Selvbetjening — tag hvad du vil have, betal på stedet.</p>
            </div>
          </FadeIn>
        </div>
      </Container>
